...
function setup() {
  ...
  thiefSprite.addAnimation("guardFront", thiefFrontStanding)
  thiefSprite.addAnimation("guardBack", thiefBackStanding)
  thiefSprite.addAnimation("guardRight", thiefRightStanding)
  thiefSprite.addAnimation("guardLeft", thiefLeftStanding)
  thiefSprite.addAnimation("guardMoveFront", thiefFrontMoving)
  thiefSprite.addAnimation("guardMoveBack",thiefBackMoving)
  thiefSprite.addAnimation("guardMoveRight",thiefRightMoving)
  thiefSprite.addAnimation("guardMoveLeft", thiefLeftMoving)
